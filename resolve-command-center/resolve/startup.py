"""
Startup implementation for Clackly.

The user-facing Resolve Utility script is Clackly.py, which delegates to this
file.

Windows user Utility script target for Clackly.py:
