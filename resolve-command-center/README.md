...
`resolve/Clackly.py` is the Resolve entrypoint and contains the launch implementation. Set `RESOLVE_COMMAND_CENTER_ROOT` to the app root before launching Resolve if `Clackly.py` is copied outside the source tree:
